...
export default function Signature({children, className}) {
    return (
        <div className={clsx("flex flex-row xl:justify-center items-center h-1/3 w-full xl:w-5/12", className)}>
            ...
            <h1 className="keyframe-slide-from-left text-3xl 2xl:text-4xl xl:pl-8 text-left">
                {children}
            </h1>
        </div>
    );
